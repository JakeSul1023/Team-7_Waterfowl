...
def export_predictions_to_json(ducks, G, days=7, use_weather=True, weather_weight=0.4,
                                output_file="SpringDucks_Predictions.json"):
    """
    Generate predictions for all ducks across multiple days and export the results to a JSON file.
    ...
    Args:
        ...
        output_file: Name of the JSON file to create
    """
    ...
    for duck_id, duck in ducks.items():
        ...
        predicted_locations, _ = predict_multiple_days(
...
if __name__ == "__main__":
    ...
    predictions_df = export_predictions_to_json(
        ducks,
        G,
        days=7,
        use_weather=True,  # Set to False to skip weather API calls
        weather_weight=0.4,
        output_file="SpringDucks_P.json"
    )

    export_predictions_to_arrow(predictions_df, output_file="SpringDucks_Predictions.arrow")
